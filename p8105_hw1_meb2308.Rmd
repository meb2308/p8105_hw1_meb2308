...
The penguins dataset has eight variables: species, island, bill length (mm), bill depth (mm), flipper length (mm), body mass (g), sex, and year. Three species of penguins were included: Adelie, Chinstrap, and Gentoo. The mean bill length is `r mean(bill_length_mm)` and the mean flipper length is `r mean(flipper_length_mm)`. 
